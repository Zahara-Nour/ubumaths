...
{{#if assessment_due_date}}
  ⏰ À rendre pour le {{assessment_due_date | date:short}}
{{else}}
  Pas de date limite
{{/if}}
...
```html
<!-- Texte -->
Bonjour {{student_name | uppercase}}
{{description | truncate:100}}

<!-- Nombres -->
Prix: {{amount | currency:EUR}}
Total: {{count | number}} élèves

<!-- Dates -->
Créé le {{created_at | date:long}}
À {{deadline | time}}
