...
- Renderers pédagogiques pour les autres domaines : matrix uniquement (intégration livrée 2026-05-06, simplification livrée 2026-05-06, **limits livré 2026-05-07** V1 + V1.1 — Option B pipeline parallèle, 8 stratégies au total : direct-substitution, known-limit, factorisation, rationalisation, infinity-analysis, lhopital (sup), one-sided, squeeze/gendarmes — voir `limits-renderer-progress.md`, **domain V1 MVP livré 2026-05-07** — Option C instrumentation directe `compute.ts`, 5 rules : sqrt/ln/log/division/arcsin/arccos + intersection + universal/empty, format aligned 3-lignes, V1.1 = tan-cot-sec-csc, preimage\_\*, composition, hyperboliques inverses sup, union/complement/difference — voir `domain-renderer-progress.md`)
