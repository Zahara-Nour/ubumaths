...
1. **Trancher Q3** : référentiel partagé global ou par prof. Impacte RLS et `skill_themes`.
2. **Trancher Q4** : niveaux scolaires V1 (6ᵉ démarrée ; cycle 4 ? 2nde ? Lycée complet ?).
3. **Trancher Q7** : versionnement intra-année du référentiel (oui/non).

(Q1, Q2, Q5, Q6, Q10, Q11, Q12 résolues — cf. §11.)
