...
| ------------------ | -------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🆘 **À remédier**  | L'élève a déjà touché la capacité mais bute dessus | `needs_remediation = true` : capacité **non acquise** avec ≥ 1 success historique mais échec(s) récent(s) qui empêchent la règle de rubrique de passer (cf. §6.1)           |
...
qui empêchent la règle de rubrique de passer
  → needs_remediation = true → badge 🆘 « À remédier »
    (l'élève a déjà touché du doigt mais bute)
