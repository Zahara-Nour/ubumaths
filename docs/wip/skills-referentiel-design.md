...
| ------------------ | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| 🆘 **À remédier**  | L'élève a déjà touché la capacité mais bute dessus | Capacité **non acquise** avec ≥ 1 success historique mais échec(s) récent(s) qui empêchent la règle de rubrique de passer (cf. §6.1)        |
| 🔁 **À renforcer** | Capacité acquise qui faiblit par non-usage         | Capacité **acquise** mais `last_success_at > 30 jours` (décroissance — visuel atténué, capacité reste acquise tant qu'aucun échec ne casse) |
