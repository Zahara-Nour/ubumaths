...
Combien y a-t-il d'adultes et d'enfants dans cette famille?`,
	...
	exercises_badge: `#grid(columns: (auto, 1fr, auto), column-gutter: 0.5em, align: horizon, box(fill: rgb("#e8590c"), radius: 3pt, inset: (x: 6pt, y: 3pt))[#text(fill: white, weight: "bold")[1]], [#text(weight: "bold")[Equations]], [])
...
#grid(columns: (auto, 1fr, auto), column-gutter: 0.5em, align: horizon, box(fill: rgb("#e8590c"), radius: 3pt, inset: (x: 6pt, y: 3pt))[#text(fill: white, weight: "bold")[2]], [#text(weight: "bold")[Perimetre]], [])
...
#grid(columns: (auto, 1fr, auto), column-gutter: 0.5em, align: horizon, box(fill: rgb("#e8590c"), radius: 3pt, inset: (x: 6pt, y: 3pt))[#text(fill: white, weight: "bold")[3]], [#text(weight: "bold")[Cinema]], [])
