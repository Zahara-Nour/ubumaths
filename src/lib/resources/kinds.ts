 ...
 * exactly the ones the cahier de texte already links to. Adding a kind is a line
 * here plus its routes in the registry; the cost lives in what gets wired behind
 * it (picker, search, tags), not in the list.
 */
