 ...
 *
 * Status (2026-05-19) : voies declared, choreography functions are stubs
 * (return empty steps + the existing principal). Concrete animations
 * deferred to a follow-up session because they require the sub-steps
 * mechanism — animating arc-then-arc-then-ruler-then-line in sequence
 * within a single DSL step. See progress doc for details.
 */
