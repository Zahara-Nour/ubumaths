...
export const createBugReportSchema = z.object({
	...
	// NOTE: screenshots are NOT set at creation. They are uploaded afterwards via
	// POST /api/bug-reports/[reportId]/screenshot, which stores only screenshot_path
	// (private bucket). Never accept a client-supplied URL here — it would be stored
	// unsigned and displayed verbatim, bypassing the signed-URL model.
