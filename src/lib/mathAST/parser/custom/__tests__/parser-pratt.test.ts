/**
 * Custom Syntax Pratt Parser - Tests
 *
 * Comprehensive tests for the custom syntax Pratt parser including:
 ...
 * - Complex expressions
 *
 * @module mathAST/parser/custom/__tests__/parser-pratt.test
 */

import { describe, it, expect } from 'vitest';
import { parseCustomPratt, parseCustomPrattSafe, ParseException } from '../parser-pratt';
import type {
	MathNode,
	DivisionNode,
	MultiplicationNode,
