...
export const MONSTER_TEMPLATES: Record<
	MonsterElement,
	Record<MonsterCategory, MonsterTemplate[]>
> = {
	fire: {
		common: [
			{
		...
		elite: [
			...
			{
				id: 'fire_fureur_des_pics',
				name: 'Fureur des Pics',
				element: 'fire',
				category: 'elite',
				imgBasename: 'fureur_des_pics'
			}
		],
		legendary: [
			{
	...
	water: {
		...
		elite: [
			...
			{
				id: 'water_rage_des_marais',
				name: 'Rage des Marais',
				element: 'water',
				category: 'elite',
				imgBasename: 'rage_des_marais'
			}
		],
		legendary: [
			{
			...
			{
				id: 'water_hippopotame',
				name: 'Hippopotame',
				element: 'water',
				category: 'legendary',
				imgBasename: 'hippopotame'
			}
		]
	},
	earth: {
		...
		elite: [
			...
			{
				id: 'earth_brute_des_plaines',
				name: 'Brute des Plaines',
				element: 'earth',
				category: 'elite',
				imgBasename: 'brute_des_plaines'
			}
		],
		legendary: [
			{
	...
	wind: {
		common: [
			{
				id: 'wind_chauve_souris',
				name: 'Chauve-Souris',
				element: 'wind',
				category: 'common',
				imgBasename: 'chauve_souris'
			},
			{
				id: 'wind_vautour',
				name: 'Vautour',
		...
		elite: [
			{
				id: 'wind_terreur_ailee',
				name: 'Terreur Ailée',
				element: 'wind',
				category: 'elite',
				imgBasename: 'terreur_ailee'
			},
			{
				id: 'wind_coureur_du_vent',
				name: 'Coureur du Vent',
				element: 'wind',
				category: 'elite',
				imgBasename: 'coureur_du_vent'
			},
			{
				id: 'wind_harpie',
				name: 'Harpie',
