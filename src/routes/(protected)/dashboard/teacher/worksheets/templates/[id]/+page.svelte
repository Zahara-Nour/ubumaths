...
<div class="container mx-auto max-w-5xl py-6">
	...
	<div class="mb-6 flex items-center gap-4">
		<Button variant="ghost" size="icon" href="/dashboard/teacher/worksheets/templates">
		...
		{#if !isNew && !canEdit}
			<Button
				variant="outline"
				href="/dashboard/teacher/worksheets/templates?action=duplicate&id={data.template?.id}"
			>
	...
	>
		...
		{#if canEdit}
			<div class="flex justify-end gap-3">
				<Button
					variant="outline"
					href="/dashboard/teacher/worksheets/templates"
					disabled={submitting}
				>
					Annuler
				</Button>
