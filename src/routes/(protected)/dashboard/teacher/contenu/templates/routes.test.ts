...
describe('GET /dashboard/teacher/contenu/templates (Gallery)', () => {
	it('should reject unauthenticated requests', async () => {
		const { load } = await import('./+page.server');

		const locals = createMockLocals(); // No user
		const params = {};
		const url = new URL('http://localhost/dashboard/teacher/contenu/templates');
	...
	it('should filter templates by grade level', async () => {
		...
		const params = {};
		const url = new URL('http://localhost/dashboard/teacher/contenu/templates?grades=3,4');
	...
	it('should search templates by title', async () => {
		...
		const params = {};
		const url = new URL('http://localhost/dashboard/teacher/contenu/templates?search=Test');
...
describe('POST /dashboard/teacher/contenu/templates/new (Create Template)', () => {
	it('should reject unauthenticated requests', async () => {
...
describe('GET /dashboard/teacher/contenu/templates/[templateId] (Detail)', () => {
	it('should reject unauthenticated requests', async () => {
		...
		const url = new URL(
			'http://localhost/dashboard/teacher/contenu/templates/' + TEST_IDS.template
		);
