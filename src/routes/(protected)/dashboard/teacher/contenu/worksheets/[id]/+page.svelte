...
<div class="container mx-auto max-w-5xl py-6">
	...
	<div class="mb-6 flex items-start justify-between">
		<div class="flex items-start gap-4">
			<Button variant="ghost" size="icon" href="/dashboard/teacher/contenu/worksheets" class="mt-1">
						...
						<div class="flex items-center justify-between">
							...
							<div class="flex gap-2">
								<Button
									variant="outline"
									size="sm"
									href="/dashboard/teacher/contenu/worksheets/{worksheet.id}/assignments/{selectedAssignment.id}/preview"
								>
												...
												<div class="flex flex-col items-end gap-2">
													...
													<div class="flex gap-1">
														<Button
															variant="ghost"
															size="sm"
															href="/dashboard/teacher/contenu/worksheets/{worksheet.id}/assignments/{assignment.id}/preview"
														...
														<Button
															variant="ghost"
															size="sm"
															href="/dashboard/teacher/contenu/worksheets/{worksheet.id}/assignments/{assignment.id}/reports"
															onclick={(e) => e.stopPropagation()}
