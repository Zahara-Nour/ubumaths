<script lang="ts">
	...
	function clearFilters() {
		...
		selectedStatus = '';
		selectedType = '';
		goto('/dashboard/teacher/contenu/worksheets', { keepFocus: true });
	}
...
<div class="container mx-auto space-y-6 py-6">
	...
	<div class="flex items-center justify-between">
		...
		<div class="flex gap-2">
			<Button variant="outline" href="/dashboard/teacher/contenu/worksheets/templates">
				<FileText class="mr-2 h-4 w-4" />
				Templates
			</Button>
			<Button href="/dashboard/teacher/contenu/worksheets/new">
						...
						{#each data.worksheets as worksheet (worksheet.id)}
							...
							<Table.Row>
								<Table.Cell class="font-medium">
									<a
										href="/dashboard/teacher/contenu/worksheets/{worksheet.id}"
