...
<svelte:head>
	<title>Valider la réponse - Chiphre</title>
</svelte:head>

<div class="container mx-auto max-w-4xl p-4 sm:p-6">
	<!-- Back Button -->
	<Button variant="ghost" href="/dashboard/teacher/contenu/enigmes/validations" class="mb-4">
	...
	<Card.Root class="mb-6">
		...
		<Card.Content>
			<div class="prose max-w-none dark:prose-invert">
				<MarkdownRenderer content={data.attempt.riddle.statement} />
			</div>
	...
	<Card.Root class="mb-6 border-2 border-primary">
		...
		<Card.Content>
			<div class="rounded-lg bg-primary/5 p-4">
				<div class="prose max-w-none dark:prose-invert">
					<MarkdownRenderer content={data.attempt.riddle.correction} />
				</div>
			</div>
		</Card.Content>
	</Card.Root>
