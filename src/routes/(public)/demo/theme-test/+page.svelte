				...
				<section class="space-y-6">
					...
					<div class="flex items-center gap-2">
						...
						<span class="text-sm text-muted-foreground">
							...
							{filteredColors.length === 1 ? 'couleur' : 'couleurs'}
						</span>
					</div>
									...
									<div class="grid grid-cols-11 gap-2">
										{#each shades as shade (shade)}
											<button
												...
												class="group relative aspect-square rounded-lg border-2 border-transparent transition-all hover:scale-110 hover:border-primary hover:shadow-lg focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none"
											...
											>
												...
												<!-- Copy icon on hover -->
												<div
													class="absolute -top-1 -right-1 rounded-full bg-background p-1 opacity-0 shadow-md transition-opacity group-hover:opacity-100"
												>
