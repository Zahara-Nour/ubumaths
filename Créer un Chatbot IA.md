...
<div class="chat-container">
	...
	<div class="chat-header">
		...
		<button class="clear-btn" onclick={clearHistory} title="Effacer l'historique"> 🗑️ </button>
	</div>
	...
	<div class="input-area">
		...
		/>
		<button onclick={sendMessage} disabled={isLoading || !inputValue.trim()} class="send-btn">
			{isLoading ? '⏳' : '📤'}
		</button>
	</div>
</div>
