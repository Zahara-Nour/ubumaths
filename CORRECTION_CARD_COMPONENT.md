...
<script>
  ...
  let answerResult: TestAnswerResult = {
    index: 0,
    instance: { /* ... */ },
    userAnswer: { /* ... */ }, // ou undefined pour mode révision
    isCorrect: true,
    timeSpent: 45,
    attempts: 1
  };
...
```svelte
<div class="flex flex-col items-center justify-center gap-3 rounded-lg border-2 border-dashed border-muted-foreground/30 bg-muted/20 p-8 text-center">
