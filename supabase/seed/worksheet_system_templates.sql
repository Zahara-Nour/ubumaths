...
VALUES (
  ...
  $tpl$Standard$tpl$,
  $tpl$Mise en page basique avec titre, informations eleve et exercices$tpl$,
...
VALUES (
  ...
  $tpl$Evaluation$tpl$,
  $tpl$Mise en page formelle pour evaluation avec section notation$tpl$,
  $tpl$// Configuration de la page
#set page(
  paper: "a4",
  margin: (top: 2cm, bottom: 2cm, left: 1.5cm, right: 1.5cm)
...
$tpl$,
  $tpl$[{"key":"title","type":"text","label":"Titre","default_value":"Feuille d'exercices"},{"key":"date","type":"date","label":"Date","default_value":""},{"key":"class","type":"text","label":"Classe","default_value":""},{"key":"student_name","type":"text","label":"Nom de l'eleve","default_value":""},{"key":"exercises","type":"dynamic","label":"Exercices","default_value":""},{"key":"total_points","type":"text","label":"Total des points","default_value":""},{"key":"duration","type":"text","label":"Duree estimee","default_value":""},{"key":"instructions","type":"text","label":"Consignes","default_value":""},{"key":"school_name","type":"text","label":"Nom de l'ecole","default_value":""},{"key":"teacher_name","type":"text","label":"Nom du professeur","default_value":""},{"key":"competences","type":"text","label":"Competences evaluees","default_value":""}]$tpl$::jsonb,
  NULL
)
ON CONFLICT (id) DO NOTHING;
...
VALUES (
  ...
  $tpl$Examen$tpl$,
  $tpl$Mise en page officielle d'examen avec en-tete, consignes et ligne de signature$tpl$,
  $tpl$// Configuration de la page
#set page(
  paper: "a4",
...
VALUES (
  ...
  $tpl$Devoirs$tpl$,
  $tpl$Mise en page simple pour devoirs a la maison$tpl$,
  $tpl$// Configuration de la page
#set page(
  paper: "a4",
  margin: (top: 2cm, bottom: 2cm, left: 1.5cm, right: 1.5cm)
...
VALUES (
  ...
  $tpl$Quiz$tpl$,
  $tpl$Format quiz rapide avec questions numerotees$tpl$,
  $tpl$// Configuration de la page
#set page(
  paper: "a4",
...
VALUES (
  ...
  $tpl$Minimaliste$tpl$,
  $tpl$Mise en page epuree et minimaliste$tpl$,
  $tpl$// Configuration de la page
#set page(
  paper: "a4",
...
VALUES (
  ...
  $tpl$Deux colonnes$tpl$,
  $tpl$Mise en page sur deux colonnes pour optimiser l'espace$tpl$,
  $tpl$// Configuration page avec marges adaptées pour colonnes
#set page(
  paper: "a4",
  margin: (top: 2cm, bottom: 2cm, left: 1.5cm, right: 1.5cm)
)
...
VALUES (
  ...
  $tpl$Paysage$tpl$,
  $tpl$Format A4 paysage avec grille optimisée pour les exercices$tpl$,
  $tpl$// Configuration en mode paysage
#set page(
  paper: "a4",
  flipped: true,
...
VALUES (
  ...
  $tpl$Magazine$tpl$,
  $tpl$Style magazine avec design éditorial, encadrés colorés et typographie variée$tpl$,
  $tpl$// Variables de couleur (définies avant #set page pour être accessibles dans footer)
...
#grid(
  ...
  $tpl$[{"key":"title","type":"text","label":"Titre","default_value":"Feuille d'exercices"},{"key":"date","type":"date","label":"Date","default_value":""},{"key":"class","type":"text","label":"Classe","default_value":""},{"key":"student_name","type":"text","label":"Nom de l'eleve","default_value":""},{"key":"exercises","type":"dynamic","label":"Exercices","default_value":""},{"key":"total_points","type":"text","label":"Total des points","default_value":""},{"key":"duration","type":"text","label":"Duree estimee","default_value":""},{"key":"instructions","type":"text","label":"Consignes","default_value":""},{"key":"school_name","type":"text","label":"Nom de l'ecole","default_value":""},{"key":"teacher_name","type":"text","label":"Nom du professeur","default_value":""},{"key":"theme_color","type":"text","label":"Couleur thème","default_value":"#e11d48"}]$tpl$::jsonb,
  NULL
)
ON CONFLICT (id) DO NOTHING;
...
VALUES (
  ...
  $tpl$Scientifique$tpl$,
  $tpl$Style académique avec tableaux de données et grille de notation formelle$tpl$,
  $tpl$// Configuration académique formelle
#set page(
  paper: "a4",
