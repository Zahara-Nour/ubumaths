-- ============================================================================
-- Migration: Add 'sold' action to VIP cards journal trigger
-- Created: 2026-04-05
-- ============================================================================
-- The log_vip_cards_to_events trigger maps vip_cards_activity actions to
-- reward_events for the student journal. 'sold' was missing, causing sold
-- cards to fall through to the ELSE branch and display as "Carte VIP" with
-- event_type='earned' instead of showing "Carte vendue".
-- ============================================================================
...
BEGIN
    ...
    CASE NEW.action
        ...
        WHEN 'sold' THEN v_event_type := 'used';
...
'Trigger on vip_cards_activity that creates reward_events for the student journal.
Maps: gained->earned, used->used, removed->removed, traded->traded, sold->used.
Skips: approved, rejected, requested.';
