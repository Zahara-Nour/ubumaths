-- =====================================================================
-- ADD 'traded' ACTION TO VIP_CARDS_ACTIVITY CHECK CONSTRAINT
-- =====================================================================
-- The execute_trade function logs card transfers with action='traded'
-- but the CHECK constraint only allows 'gained', 'used', 'removed'.
--
-- This migration adds 'traded' to the allowed actions.
-- =====================================================================
...
-- Add new constraint with 'traded' action
ALTER TABLE public.vip_cards_activity
ADD CONSTRAINT vip_cards_activity_action_check
CHECK (action IN ('gained', 'used', 'removed', 'traded'));

-- Update the column comment
COMMENT ON COLUMN public.vip_cards_activity.action IS 'Action type: gained, used, removed, or traded';

-- Also update execute_trade to use 'traded' consistently (it was using 'marketplace_trade')
-- The migration 20260103215000 already uses 'marketplace_trade', let's fix it
...
BEGIN
    ...
    LOOP
        ...
        -- Log in vip_cards_activity with 'traded' action
...
COMMENT ON FUNCTION public.execute_trade IS 'Atomically execute a completed trade. Logs traded action to vip_cards_activity.';
