-- Fix use_hint RPC: replace stale hints_from_items reference with reduced_penalty_hints
--
-- The column was renamed in migration 20260302072940, but migration 20260302164820
-- re-created use_hint() with the old column name hints_from_items.
