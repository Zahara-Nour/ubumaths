-- =====================================================================
-- FIX EXECUTE_TRADE GIDOUILLES TRANSFER
-- =====================================================================
-- The update_student_gidouilles function now requires class_id and has
-- stricter authorization checks that don't work for student-to-student trades.
--
-- Fix: Update profiles.gidouilles directly in execute_trade since it
-- already has SECURITY DEFINER and proper authorization checks.
-- =====================================================================
...
BEGIN
    ...
    -- ========================================================================
    -- Calculate final gidouilles balances and update profiles
    -- ========================================================================
    -- Net transfer: initiator gives v_initiator_gidouilles, receives v_partner_gidouilles
    -- Net transfer: partner gives v_partner_gidouilles, receives v_initiator_gidouilles
...
'Atomically execute a trade. Updates vip_cards and gidouilles directly. Logs activities for both parties.';
