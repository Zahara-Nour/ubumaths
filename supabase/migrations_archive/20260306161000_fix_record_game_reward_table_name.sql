-- ============================================================================
-- Migration: Fix table name in record_game_reward()
-- Created: 2026-03-06
-- ============================================================================
-- BUG: gidouilles_history was renamed to gidouilles_activity in migration
--      20260103235000, but record_game_reward() still referenced the old name.
-- ============================================================================
...
BEGIN
  ...
  IF v_is_first_win THEN
    ...
    -- Log in activity (renamed from gidouilles_history)
