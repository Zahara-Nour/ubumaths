-- Migration 101: Fix ambiguous role column in get_allowed_recipients function
-- Description: Fixes PostgreSQL error "column reference 'role' is ambiguous"

-- =====================================================
-- FUNCTION: Get allowed recipients for a user (FIXED)
-- =====================================================
