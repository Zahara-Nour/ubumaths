-- ============================================================================
-- Migration: Add rank to complete_minesweeper_game breakdown
-- Created: 2026-04-03
-- ============================================================================
-- Adds old_rank and new_rank to the breakdown JSON returned by
-- complete_minesweeper_game, so the VictoryModal can show rank evolution.
-- ============================================================================
...
COMMENT ON FUNCTION public.complete_minesweeper_game(UUID, JSONB) IS
  'Completes Minesweeper game. Returns breakdown with leaderboard evolution (old/new avg_top10 and rank).';
