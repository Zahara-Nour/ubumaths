-- =====================================================================
-- ADD GIDOUILLES HISTORY LOGGING TO EXECUTE_TRADE
-- =====================================================================
-- The gidouilles transfers during trades should be logged in
-- gidouilles_history for proper tracking and auditing.
--
-- For trades, class_id is NULL since it's peer-to-peer.
-- Reason format: "Echange avec [partner_name]"
-- =====================================================================
...
BEGIN
    ...
    -- ========================================================================
    -- Update profiles and log gidouilles history
    -- ========================================================================
    ...
    -- Log gidouilles history for initiator (if any gidouilles were exchanged)
    IF v_initiator_gidouilles > 0 THEN
...
'Atomically execute a trade. Updates vip_cards and gidouilles directly. Logs to vip_cards_activity and gidouilles_history.';
