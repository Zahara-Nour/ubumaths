-- ============================================================================
-- Migration: Add leaderboard evolution to complete_minesweeper_game
-- Created: 2026-04-03
-- ============================================================================
-- Returns old_avg_top10 and new_avg_top10 in breakdown so the VictoryModal
-- can show how the player's leaderboard score evolved with this game.
-- ============================================================================
...
BEGIN
  ...
  FROM (
    ...
    WHERE mg.student_id = v_game_record.student_id
      AND mg.status = 'won'
...
COMMENT ON FUNCTION public.complete_minesweeper_game(UUID, JSONB) IS
  'Completes Minesweeper game. Returns breakdown with leaderboard evolution (old/new avg_top10).';
