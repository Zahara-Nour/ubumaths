-- ============================================================================
-- Fix gidouilles_history Column Names in complete_minesweeper_game()
-- ============================================================================
-- Issue: Using 'amount' and 'reference_id' columns that don't exist
-- Table schema has: delta (not amount), no reference_id column
-- ============================================================================
...
-- MIGRATION SUMMARY
-- ============================================================================
-- ✅ Fixed gidouilles_history columns: delta (not amount)
-- ✅ Removed reference_id (column doesn't exist in table)
-- ✅ Maintains all other functionality (achievements, rewards, validation)
