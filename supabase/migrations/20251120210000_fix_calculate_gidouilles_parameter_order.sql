-- ============================================================================
-- FIX: Correct parameter order in complete_minesweeper_game() function
-- ============================================================================
-- Issue: Parameters passed to calculate_minesweeper_gidouilles() are in wrong order
...
-- Error: "function public.calculate_minesweeper_gidouilles(text, integer, integer, uuid) does not exist"
-- ============================================================================
...
BEGIN
  ...
  -- Function signature: calculate_minesweeper_gidouilles(p_difficulty TEXT, p_time_seconds INTEGER, p_student_id UUID, p_hints_used INTEGER)
...
COMMENT ON FUNCTION public.complete_minesweeper_game IS
  'FIX: Corrected calculate_minesweeper_gidouilles() parameter order. Completes a Minesweeper game, validates win condition, calculates rewards, and updates achievements.';

-- ============================================================================
-- MIGRATION SUMMARY
-- ============================================================================
-- ✅ Fixed parameter order: (difficulty, time, student_id, hints)
-- ✅ Matches calculate_minesweeper_gidouilles signature
-- ✅ Prevents "function does not exist" error on game completion
