-- ============================================================================
-- Migration: Log gidouilles spent when drawing VIP cards
-- Created: 2026-03-12
-- ============================================================================
-- BUG: draw_multiple_vip_cards() deducts gidouilles from profiles directly
--      but never inserts into gidouilles_activity. The spending doesn't
--      appear in the student's reward journal.
--
-- FIX: Add INSERT into gidouilles_activity after gidouilles deduction.
--      The existing trigger propagates to reward_events automatically.
-- ============================================================================
...
Logs gidouilles spent to gidouilles_activity for journal visibility.';
