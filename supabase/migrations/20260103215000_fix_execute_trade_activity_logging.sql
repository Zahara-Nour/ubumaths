-- =====================================================================
-- FIX EXECUTE_TRADE ACTIVITY LOGGING
-- =====================================================================
-- The execute_trade function was missing card_template_id in the INSERT
-- statements for vip_cards_activity. This caused NOT NULL constraint
-- violations when executing trades.
--
-- Fix: Add card_template_id to all INSERT INTO vip_cards_activity
-- The template ID comes from v_card_data->>'cardId'
-- =====================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- Log in vip_cards_activity (FIXED: includes card_template_id)
...
COMMENT ON FUNCTION public.execute_trade IS 'Atomically execute a completed trade with full rollback on failure. Includes card_template_id in activity logging.';
