-- ============================================================================
-- Migration: Update complete_minesweeper_game() for Dynamic Reference Times
-- Purpose: Return cycle and dynamic reference_time in breakdown
-- Date: 2026-01-01
-- ============================================================================
--
-- CHANGES:
-- 1. Get student's grade and cycle
-- 2. If no cycle, still complete game but with 0 gidouilles
-- 3. Use dynamic reference_time from minesweeper_reference_times
-- 4. Add 'cycle' field to breakdown JSONB
--
-- BREAKDOWN now includes:
--   - cycle: The student's pedagogical cycle (or null if no grade)
--   - reference_time: Dynamic time for this cycle/difficulty
--
-- ============================================================================
...
BEGIN
  ...
  -- Step 6e: Calculate daily multiplier
  ...
  -- Step 6f: Calculate gidouilles (only for students WITH a grade/cycle)
  ...
  -- Build breakdown JSONB (now includes cycle)
  v_breakdown := jsonb_build_object(
    'cycle', v_cycle,  -- NEW: pedagogical cycle (or null)
...
COMMENT ON FUNCTION public.complete_minesweeper_game IS
  'Completes Minesweeper game with Strategy D and dynamic reference times.

   IMPORTANT: Students without a grade defined earn 0 gidouilles.

   Returns:
     - gidouilles_earned: Decimal (0.3-8.0), or 0 if no grade
     ...
     - breakdown: Detailed calculation factors including:
         ...
         - time_mult, hint_penalty, daily_mult: Multipliers used';
