...
/**
 * Corrigés des 11 exercices d'optimisation (fiche « Applications des fonctions
 * polynôme du second degré ») — 18 variations, FR + EN (2026-09-24)
 * ==========================================================================
 *
 ...
 *
 * Usage :
 *   pnpm tsx scripts/add-corriges-optimisation-2nd-degre.ts            # simulation
 *   pnpm tsx scripts/add-corriges-optimisation-2nd-degre.ts --publier  # écrit en prod
 */
...
const DIR =
	'/private/tmp/claude-501/-Users-david-Coding-js-ubumaths/5a4e98b0-c76d-42bf-8e8c-ee835a4273ea/scratchpad/optim';

type Entree = { key: string; id: string; title: string; idx: number };
