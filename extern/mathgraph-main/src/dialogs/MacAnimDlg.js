...
export default MacAnimDlg

/**
 * Dialogue de création ou modification d'une macro d'animation de point lié
 * @constructor
 ...
 */
function MacAnimDlg (app, bAvecTraces, mac, modification, callBackOK, callBackCancel) {
  ...
  this.paneAnimation = new PaneAnimation(app, modification ? new InfoAnim(mac) : app.pref_Anim, true, true, false)
  ...
  this.onchange()
  this.create(bAvecTraces ? 'MacAnimTr' : 'MacAnim', 500)
}

MacAnimDlg.prototype = new MacroDlg()

MacAnimDlg.prototype.OK = function () {
...
MacAnimDlg.prototype.onchange = function () {
...
MacAnimDlg.prototype.onradio2change = function () {
  const sel = $('#inputdur')
  const b = $('#cbuncyc').prop('checked')
